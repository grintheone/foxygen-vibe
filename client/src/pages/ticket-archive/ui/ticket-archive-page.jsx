...
function ArchiveFilterSheet({
    ...
    return (
        ...
        >
            ...
            <div className="sticky bottom-[calc(-1.5rem-env(safe-area-inset-bottom))] -mx-6 flex gap-3 border-t border-white/15 bg-slate-950/95 px-6 pt-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] backdrop-blur">
                <button
                    type="button"
                    onClick={onReset}
