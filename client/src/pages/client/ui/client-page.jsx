    ...
    <PageShell>
      <section className="w-full space-y-6">
        <header className="rounded-3xl border border-white/10 bg-slate-950/35 p-6 shadow-xl shadow-black/20 backdrop-blur">
          ...
          <p className="mt-4 text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Клиент</p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Карточка клиента</h1>
        </header>

        <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
          <p className="text-sm text-slate-200">Страница клиента {clientId || "—"} (временный экран).</p>
        </div>
